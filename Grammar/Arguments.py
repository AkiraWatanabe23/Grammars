...
def func_one(num):
    ...
    print(id(num)) #引数nのIDを出力

def pass_by_value_like(num2):
    '''値渡しの動き'''
    print(num2)
    num2 += 5
    print(num2)
...
print(PASS_NUM)              # -> 10
pass_by_value_like(PASS_NUM) # -> 10
#                       -> 15
print(PASS_NUM)              # -> 10 ... 呼び出し元の変数の値に変更がない
